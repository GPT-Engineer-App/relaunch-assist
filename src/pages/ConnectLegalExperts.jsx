...
const ConnectLegalExperts = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("User connected with legal expert:", formData);
  };

  return (
    <Box p={4}>
      <VStack spacing={6} align="stretch">
        <Heading as="h1" size="xl" textAlign="center">Connect with Legal Experts</Heading>
...
export default ConnectLegalExperts;